...
export const realFeedItems: RealFeedItem[] = [
  ...
  // ============================================================
  {
    ...
    translationVi:
      "Cẩm nang Thành Đô 3 ngày 2 đêm đây! 🐼 Trung tâm gấu trúc đỉnh, xin reco quán lẩu! Bị cấy thèm 1 quán uyên ương quả, lần sau qua nhất định check-in. #cẩmnangThànhĐô #gấutrúc",
    spokenVersion: {
      ...
      vi: "Cẩm nang Thành Đô 3 ngày 2 đêm! Trung tâm gấu trúc tuyệt, ai có reco quán lẩu không?",
    },
    businessSafeVersion: {
      zh: "(社交媒体文案不用于商务沟通。)",
    ...
    keyVocabulary: [
      { id: "rf6-v1", hanzi: "攻略", pinyin: "gōnglüè", vietnameseMeaning: "cẩm nang, guide", synonyms: [], exampleZh: "旅游攻略。", exampleVi: "Cẩm nang du lịch.", tags: ["social", "travel"], frequencyLevel: "high" },
      { id: "rf6-v2", hanzi: "yyds", pinyin: "yyds (永远的神)", vietnameseMeaning: "GOAT, đỉnh", synonyms: [], exampleZh: "yyds！", exampleVi: "Đỉnh!", tags: ["social", "slang"], frequencyLevel: "high" },
      { id: "rf6-v3", hanzi: "求推荐", pinyin: "qiú tuījiàn", vietnameseMeaning: "xin reco", synonyms: [], exampleZh: "火锅求推荐。", exampleVi: "Xin reco quán lẩu.", tags: ["social"], frequencyLevel: "high" },
      { id: "rf6-v4", hanzi: "种草", pinyin: "zhòng cǎo", vietnameseMeaning: "bị cấy thèm mua", synonyms: [], exampleZh: "被种草了。", exampleVi: "Bị cấy thèm rồi.", tags: ["social", "slang"], frequencyLevel: "high" },
      { id: "rf6-v5", hanzi: "打卡", pinyin: "dǎ kǎ", vietnameseMeaning: "check-in (điểm hot)", synonyms: [], exampleZh: "必打卡。", exampleVi: "Nhất định check-in.", tags: ["social", "travel"], frequencyLevel: "high" },
    ],
    sentencePatterns: [
      { id: "rf6-s1", zh: "... 攻略来啦！", pinyin: "... gōnglüè lái la!", vi: "Cẩm nang ... đây!", register: "casual" },
      { id: "rf6-s2", zh: "... yyds，求推荐 ...", pinyin: "... yyds, qiú tuījiàn ...", vi: "... đỉnh, xin reco ...", register: "casual" },
      { id: "rf6-s3", zh: "被种草了一家 ...，必打卡。", pinyin: "Bèi zhòng cǎo le yī jiā ..., bì dǎ kǎ.", vi: "Bị cấy thèm 1 quán ..., nhất định check-in.", register: "casual" },
    ],
    ...
    annotatedPractice: {
      ...
      sentence: {
        ...
        vi: "Thành Đô đỉnh, bị cấy thèm lẩu, lần sau nhất định check-in!",
      },
    },
    roleplayScenario: {
      id: "rf6-rp",
  ...
  // ============================================================
  {
    id: "rf-7",
    titleZh: "抖音热梗：周末躺平",
    titleVi: "Douyin slang — cuối tuần nằm thẳng",
    sourceType: "social",
    difficulty: "easy",
    ...
    visual: {
      ...
      captionVi: "Slang 躺平 + 佛系 + 真香 — kinh điển 2020+",
    },
    originalZh:
    ...
    translationVi:
      "Cuối tuần chỉ muốn nằm thẳng! Đừng ai gọi tôi, trà sữa + phim + máy lạnh = tuyệt cú mèo. Vốn nói không uống trà sữa, kết quả nhấp 1 ngụm: thật ra ngon.",
    spokenVersion: {
      zh: "周末就想躺着不动，喝奶茶看剧，最爽。",
      pinyin: "Zhōumò jiù xiǎng tǎng zhe bù dòng, hē nǎichá kàn jù, zuì shuǎng.",
      vi: "Cuối tuần chỉ muốn nằm im, uống trà sữa xem phim, sướng nhất.",
    },
    businessSafeVersion: {
      zh: "(社交吐槽不用于商务。)",
      pinyin: "(Shèjiāo tǔcáo bù yòng yú shāngwù.)",
      vi: "(Than vãn MXH — không business.)",
    },
    usageNotesVi:
      "躺平 + 真香 = combo slang Gen-Z phổ biến nhất. Hài, khoe lười 1 cách dễ thương.",
    whenToUseVi: "Post Weibo / status WeChat Moments cá nhân.",
    whenNotToUseVi: "Group WeChat công ty, sếp đọc được.",
    keyVocabulary: [
      { id: "rf7-v1", hanzi: "躺平", pinyin: "tǎng píng", vietnameseMeaning: "nằm thẳng, chịu thua", synonyms: [], exampleZh: "我躺平了。", exampleVi: "Tôi nằm thẳng rồi.", tags: ["social", "slang"], frequencyLevel: "high" },
      ...
      { id: "rf7-v3", hanzi: "绝绝子", pinyin: "juéjuézǐ", vietnameseMeaning: "tuyệt cú mèo", synonyms: [], exampleZh: "颜值绝绝子。", exampleVi: "Nhan sắc tuyệt cú mèo.", tags: ["social", "slang"], frequencyLevel: "high" },
      ...
      { id: "rf7-v5", hanzi: "真香", pinyin: "zhēn xiāng", vietnameseMeaning: "(mỉa mai) thật ra ngon / 'thơm thật'", synonyms: [], exampleZh: "真香！", exampleVi: "Thơm thật! (= 'lại thèm')", tags: ["social", "slang"], frequencyLevel: "high" },
    ],
    sentencePatterns: [
      { id: "rf7-s1", zh: "周末就是要 ... ！", pinyin: "Zhōumò jiùshì yào ... !", vi: "Cuối tuần chỉ muốn ...!", register: "casual" },
      { id: "rf7-s2", zh: "本来说 ...，结果 ...", pinyin: "Běnlái shuō ..., jiéguǒ ...", vi: "Vốn nói ..., kết quả ...", register: "casual" },
      { id: "rf7-s3", zh: "一口下去：真香。", pinyin: "Yī kǒu xiàqù: zhēn xiāng.", vi: "Nhấp 1 ngụm: thật ra ngon.", usageNoteVi: "Mẫu câu meme.", register: "casual" },
    ],
    registerNotesVi: "Slang Gen-Z — caption Weibo / Douyin cá nhân.",
    discussionPrompts: ["Bạn 'real-life 躺平' khi nào?"],
    speakingPrompts: ["Viết 1 caption cuối tuần kiểu 躺平 + 真香 cho bản thân."],
    roleplayScenario: {
      id: "rf7-rp",
      titleVi: "Bình luận trêu bạn vừa post 躺平",
      titleZh: "调侃朋友的躺平贴",
      contextVi: "Bạn comment 1 post bạn thân đang khoe nằm thẳng. Trêu vài câu vui.",
      aiRole: "Bạn thân vừa post",
      userRole: "Vân Trang — đi comment",
  ...
  // ============================================================
  {
    id: "rf-11",
    titleZh: "现代剧片段：吐槽加班",
    titleVi: "Phim hiện đại: than vãn về OT (đoạn gốc)",
    sourceType: "social",
    difficulty: "easy",
    topicTags: ["drama", "modern", "workplace"],
    categoryGroup: "social",
    visual: {
      type: "learning_scene",
      ...
      emoji: "😩",
      gradient: "drama-modern",
      altVi: "Quán cà phê đêm — 2 cô bạn tâm sự",
      captionVi: "Đoạn tâm sự kinh điển trong phim công sở",
    },
    originalZh:
      "你说我容易吗？每天加班到十点，老板还嫌我慢。算了，下个月辞职。",
    pinyin:
      "Nǐ shuō wǒ róngyì ma? Měi tiān jiābān dào shí diǎn, lǎobǎn hái xián wǒ màn. Suàn le, xià gè yuè cízhí.",
    translationVi:
      "Cậu nói tớ dễ không? Ngày nào cũng OT đến 10 giờ, sếp còn chê tớ chậm. Thôi, tháng sau nghỉ.",
    spokenVersion: {
      zh: "我太难了，天天加班还被骂，下个月不干了。",
      pinyin: "Wǒ tài nán le, tiāntiān jiābān hái bèi mà, xià gè yuè bù gàn le.",
      vi: "Tớ khổ quá, ngày nào cũng OT còn bị mắng, tháng sau không làm nữa.",
    },
    businessSafeVersion: {
      zh: "(吐槽朋友间话，不用于上班沟通。)",
      pinyin: "(Tǔcáo péngyǒu jiān huà, bù yòng yú shàngbān gōutōng.)",
      vi: "(Lời tâm sự giữa bạn — không dùng tại công ty.)",
    },
    usageNotesVi:
      "你说我容易吗 = câu kinh điển ngụ ý 'thông cảm cho tớ đi'. Combo 算了 + 辞职 = drama công sở mẫu.",
    whenToUseVi: "WeChat với bạn thân, cuộc gọi tâm sự.",
    whenNotToUseVi: "Group công ty, sếp đọc được.",
    keyVocabulary: [
      { id: "rf11-v1", hanzi: "容易", pinyin: "róngyì", vietnameseMeaning: "dễ, dễ dàng", synonyms: [], exampleZh: "不容易啊。", exampleVi: "Không dễ đâu.", tags: ["drama"], frequencyLevel: "high" },
      { id: "rf11-v2", hanzi: "加班", pinyin: "jiābān", vietnameseMeaning: "tăng ca, OT", synonyms: [], exampleZh: "加班到十点。", exampleVi: "OT đến 10 giờ.", tags: ["drama", "work"], frequencyLevel: "high" },
      { id: "rf11-v3", hanzi: "嫌", pinyin: "xián", vietnameseMeaning: "chê", synonyms: [], exampleZh: "嫌我慢。", exampleVi: "Chê tôi chậm.", tags: ["drama", "emotion"], frequencyLevel: "medium" },
      { id: "rf11-v4", hanzi: "算了", pinyin: "suàn le", vietnameseMeaning: "thôi đi, bỏ qua", synonyms: [], exampleZh: "算了，不说了。", exampleVi: "Thôi, không nói nữa.", tags: ["drama"], frequencyLevel: "high" },
      { id: "rf11-v5", hanzi: "辞职", pinyin: "cízhí", vietnameseMeaning: "nghỉ việc", synonyms: [], exampleZh: "下月辞职。", exampleVi: "Tháng sau nghỉ.", tags: ["drama", "work"], frequencyLevel: "medium" },
    ],
    sentencePatterns: [
      { id: "rf11-s1", zh: "你说我容易吗？", pinyin: "Nǐ shuō wǒ róngyì ma?", vi: "Cậu nói tớ dễ không?", usageNoteVi: "Câu mở đầu tâm sự xin thông cảm.", register: "casual" },
      { id: "rf11-s2", zh: "每天加班到 ... 点。", pinyin: "Měi tiān jiābān dào ... diǎn.", vi: "Ngày nào cũng OT đến ... giờ.", register: "casual" },
      { id: "rf11-s3", zh: "算了，下个月辞职。", pinyin: "Suàn le, xià gè yuè cízhí.", vi: "Thôi, tháng sau nghỉ.", register: "casual" },
    ],
    registerNotesVi: "Casual giữa bạn — drama hơi đùa hơi thật.",
    discussionPrompts: ["Bạn từng tâm sự về OT với ai gần đây nhất?"],
    speakingPrompts: ["Tâm sự ngược lại bạn thân: 1 ngày dài của bạn (3-4 câu)."],
    roleplayScenario: {
      id: "rf11-rp",
      titleVi: "Cùng bạn than về sếp khó",
      titleZh: "和朋友一起吐槽老板",
      contextVi: "AI là bạn thân vừa nghe bạn kể. Phản ứng đồng cảm, cho lời khuyên.",
      aiRole: "Bạn thân — đồng cảm",
      userRole: "Vân Trang — người tâm sự",
      targetPhrases: ["不容易", "加班", "嫌", "算了"],
      difficulty: "easy",
    },
  },
  ...
  // ============================================================
  {
    ...
    translationVi:
      "#PhimNàoĐóTốiNayLênSóng# 🔥 Netizen: nhan sắc on point, plot căng, mong đừng dở ending. Xin reco bài nhạc chủ đề cùng!",
    spokenVersion: {
    ...
    businessSafeVersion: {
      zh: "(社交热搜非商务话题。)",
      pinyin: "(Shèjiāo rèsōu fēi shāngwù huàtí.)",
      vi: "(Hot search MXH — không phải chủ đề business.)",
    },
    usageNotesVi:
      "Format hot search: # hashtag # + 网友 + tag cảm xúc + cụm slang (颜值在线 / 剧情拉满 / 烂尾 / 求安利).",
    whenToUseVi: "Khi lướt Weibo / Douyin và muốn join trend.",
    whenNotToUseVi: "Email, báo cáo, post LinkedIn.",
    keyVocabulary: [
      { id: "rf12-v1", hanzi: "开播", pinyin: "kāibō", vietnameseMeaning: "lên sóng (phim/show)", synonyms: [], exampleZh: "今晚开播。", exampleVi: "Tối nay lên sóng.", tags: ["social", "drama"], frequencyLevel: "high" },
      { id: "rf12-v2", hanzi: "颜值在线", pinyin: "yánzhí zài xiàn", vietnameseMeaning: "nhan sắc on point (slang)", synonyms: [], exampleZh: "男主颜值在线。", exampleVi: "Nam chính nhan sắc on point.", tags: ["social", "slang"], frequencyLevel: "high" },
      { id: "rf12-v3", hanzi: "剧情拉满", pinyin: "jùqíng lā mǎn", vietnameseMeaning: "(slang) plot phim căng / đầy đặn", synonyms: [], exampleZh: "前两集剧情拉满。", exampleVi: "2 tập đầu plot căng.", tags: ["social", "drama"], frequencyLevel: "medium" },
      { id: "rf12-v4", hanzi: "烂尾", pinyin: "lànwěi", vietnameseMeaning: "(slang) dở ending, hỏng đoạn kết", synonyms: [], exampleZh: "希望不烂尾。", exampleVi: "Mong đừng dở ending.", tags: ["social", "drama"], frequencyLevel: "high" },
      { id: "rf12-v5", hanzi: "求安利", pinyin: "qiú ānlì", vietnameseMeaning: "(slang) xin recommend", synonyms: ["求推荐"], exampleZh: "求安利好剧。", exampleVi: "Xin reco phim hay.", tags: ["social", "slang"], frequencyLevel: "high" },
    ],
    sentencePatterns: [
      { id: "rf12-s1", zh: "#... 今晚开播 # 🔥", pinyin: "#... jīn wǎn kāibō# 🔥", vi: "#... TốiNayLênSóng# 🔥", register: "casual" },
      { id: "rf12-s2", zh: "颜值在线，剧情拉满。", pinyin: "Yánzhí zài xiàn, jùqíng lā mǎn.", vi: "Nhan sắc on point, plot căng.", register: "casual" },
      { id: "rf12-s3", zh: "希望别烂尾。", pinyin: "Xīwàng bié lànwěi.", vi: "Mong đừng dở ending.", register: "casual" },
      { id: "rf12-s4", zh: "求安利 ...", pinyin: "Qiú ānlì ...", vi: "Xin reco ...", register: "casual" },
    ],
    registerNotesVi: "Slang Weibo — mỗi tháng có cụm mới, biết khung cấu trúc là đủ.",
    discussionPrompts: ["Phim Trung 2026 nào bạn đang hóng?"],
    speakingPrompts: ["Viết 1 post Weibo về phim Trung bạn vừa xem (3-4 câu, có slang)."],
    annotatedPractice: {
      keyChips: ["开播", "颜值在线", "求安利"],
      sentence: {
        zh: "今晚新剧开播，颜值在线，求安利同款 OST！",
        pinyin: "Jīn wǎn xīn jù kāibō, yánzhí zài xiàn, qiú ānlì tóng kuǎn OST!",
        vi: "Tối nay phim mới lên sóng, nhan sắc on point, xin reco bài OST!",
      },
    },
    roleplayScenario: {
      id: "rf12-rp",
